...
print"<tr id='names'>"
print"<th><img src='https://www.imageupload.co.uk/images/2018/03/16/MoonRender.png'"
print"style='width:50; height:50'></th>"
print"<th>Ημερο-<br>μηνία</th>"
print"<th>Ώρα</th>"
print"<th>Θερμο-<br>κρασία</th>"
print"<th>Υγρασία</th>"
print"<th>Βαρομετρίκη Πίεση</th>"
print"<th>Κατεύθηνση Ανέμου</th>"
print"<th>Ταχύτητα Ανέμου</th>"
print"<th>Μέγιστη Ταχύτητα Ανέμου</th>"
print"<th>Χιλιοστά Βροχής</th>"
print"<th>Ραδιε-<br>νέργια</th>"
print"<th>Ακτινο-<br>βολία</th>"
print"<th>EVPT</th>"
...
for i in my_cursor:
	...
	print "<td align='center'>", b, "mmHg</td>"
	...
	print "<td align='center'>",i.EVPT,"</td>"
